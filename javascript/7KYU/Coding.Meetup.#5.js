...
const countLanguages = (list) => {
    ...
    for (developers of list){
        if (obj[developers.language]){
            obj[developers.language]++;
        }else{
            obj[developers.language] = 1;
        }
    }
    return obj;
}
...
const countLanguages2 = (list) => {
    return list.reduce((obj, developers) => {
        obj[developers.language] = obj[developers.language] + 1 || 1;
        return obj;
    }, {})
}
