...
const addUsername =(list) => {
    ...
    for (let developers of list){
      const birthYear = currentYear - developers.age
      const username = `${developers.firstName.toLowerCase()}${developers.lastName.charAt(0).toLowerCase()}${birthYear}`
...
// Another Solution
const addUsername2 = list => {
    const currentYear = new Date().getFullYear()
    list.forEach(developer => {
      developer.username = `${developer.firstName.toLowerCase()}${developer.lastName[0].toLowerCase()}${currentYear - developer.age}`
    })
    return list
}
...
const addUsername3= list => {
    const currentYear = new Date().getFullYear()
    return list.map(developer => ({
      ...developer,
      username: `${developer.firstName.toLowerCase()}${developer.lastName[0].toLowerCase()}${currentYear - developer.age}`
    }))
}