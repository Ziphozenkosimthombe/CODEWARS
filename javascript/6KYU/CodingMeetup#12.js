...
const findAdmin = (list, lang) => list.filter(developer => developer.language === lang && developer.githubAdmin === 'yes')

// Another Solution
const findAdmin2 = (list, lang) => {
    for (let developers of list){
        if (developers.language === lang && developers.githubAdmin === 'yes'){
            return developers
        }
    }
    return []
